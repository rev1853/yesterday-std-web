            ...
            {albums.map((album) => (
              ...
              >
                <div className="relative">
                  <div 
                    className="h-[300px] bg-cover bg-center transition-transform duration-300 group-hover:scale-105"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="font-['Inter'] font-extrabold text-[24px] text-white tracking-[-1.2px] mb-2">
                      {album.title}
                    </h3>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex items-center justify-center gap-2 px-4 py-2 bg-neutral-100/5 rounded-lg group-hover:bg-neutral-100/10 transition-colors">
                    <Eye className="w-4 h-4 text-neutral-300" />
                    <span className="font-['Inter'] text-[12px] text-neutral-300">
                      View Album
                    </span>
                  </div>
                </div>
